...
(function () {
  //  Helper functions
  console.log('Hey Brandy!')
  console.log('On the left side you\'ll see a list of files, and a folder at the top named "Brandy". Within that folder you\'ll see the css.scss file which would be the file to edit your SASS (SCSS) variables.')
  console.error('Do not edit any of the other files yet.')
  console.log('❤️')
